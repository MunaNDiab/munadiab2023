        ...
        >
            ...
            >
                ...
                {questions[currentQuestion].options.map((option, index) => (
                    <button
                        ...
                        style={{
                            margin: '10px',
                            padding: '10px',
                            backgroundColor: selectedOption === option ? '#008CBA' : '#4CAF50',
                            color: 'white',
                            border: 'none',
                            borderRadius: '5px',
                            fontSize: '18px',
                ...
                <div style={{ marginTop: '20px' }}>
                    <span style={{ fontWeight: 'bold' }}>الوقت المتبقي: </span>
                    <span style={{ color: remainingTime <= 5 ? 'red' : 'black' }}>{remainingTime} ثواني</span>
                </div>
